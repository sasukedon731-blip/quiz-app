...
export const quizCatalog: QuizDef[] = [
...

  {
    ...
    modes: ["normal", "review"],
    sections: [
      { id: "hokkaido", title: "北海道", enabled: true, order: 1 },
      { id: "tohoku", title: "東北・秋田", enabled: true, order: 2 },
      { id: "nagoya", title: "名古屋・愛知", enabled: true, order: 3 },
      { id: "kansai", title: "関西", enabled: true, order: 4 },
      { id: "hiroshima", title: "広島", enabled: true, order: 5 },
      { id: "hakata", title: "博多・九州", enabled: true, order: 6 },
      { id: "okinawa", title: "沖縄", enabled: true, order: 7 },
    ],
  },

  {
    ...
    industries: "all",
    modes: ["normal", "review"],
    sections: [{ id: "kansai", title: "関西", enabled: true, order: 1 }],
  },

  {
    ...
    industries: "all",
    modes: ["normal", "review"],
    sections: [{ id: "conversation", title: "会話理解", enabled: true, order: 1 }],
  },
