...
（かいがん）の漢字は？`,
    ...
    },
    {
      id: 5,
      sectionId: "moji-goi",
      question: `近くのコンビニの（てんいん）さんは、とても親切です。
（てんいん）の漢字は？`,
      choices: ["店員", "店人", "点員", "店内"],
      correctIndex: 0,
      explanation:
        "正解は「店員」です。 読み（かな）に対応する漢字を選びます。迷ったら、前後の文脈（何をする/どんな状態）で意味を確認しましょう。",
    },
    {
      id: 6,
      sectionId: "moji-goi",
...
（きけん）の漢字は？`,
    ...
    },
    {
      id: 10,
      sectionId: "moji-goi",
      question: `明日の旅行の（じゅんび）は、もう終わりましたか。
（じゅんび）の漢字は？`,
      choices: ["準備", "準美", "久敬", "准備"],
      correctIndex: 0,
      explanation:
        "正解は「準備」です。 読み（かな）に対応する漢字を選びます。迷ったら、前後の文脈（何をする/どんな状態）で意味を確認しましょう。",
    },
    {
      id: 11,
      sectionId: "moji-goi",
...
（ ）に入る助詞は？`,
      ...
      correctIndex: 1,
      explanation:
        "正解は「へ」です。 助詞は「だれが/だれに/なにを/どこで/どこへ/いつ」を当てはめると選びやすいです。",
    },
    {
      id: 52,
      sectionId: "bunpo",
...
（　）に入る言葉を選んでください。`,
      ...
      correctIndex: 0,
      explanation:
        "正解は「注意」です。 その場面で自然に使う語を選びます。似た語があるときは「何について/誰に/どこで使うか」で区別します。",
    },
    {
      id: 65,
      sectionId: "reading",
